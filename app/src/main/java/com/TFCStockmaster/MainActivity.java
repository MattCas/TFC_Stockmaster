...
//			}
  ...
  private void dispatchTakePictureIntent(String stockid) {
    ...
    if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
      ...
      try {
        ...
        Toast toast = Toast.makeText(this, "image creation failed", Toast.LENGTH_SHORT);
        toast.show();
      }
      // Continue only if the File was successfully created
      if (photoFile != null) {
        Toast toast = Toast.makeText(this, "image creation success", Toast.LENGTH_SHORT);
        toast.show();
        takePictureIntent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        // mCurrentPhotoPath Replaced the following Uri.fromFile(new File(imagePath)));
        // Check if working
  ...
  private void setPic() {
    ...
    BitmapFactory.decodeFile("/storage/emulated/0/DCIM/Camera/IMG_20201005_064250.jpg", bmOptions);
    ...
    Bitmap bitmap = BitmapFactory.decodeFile("/storage/emulated/0/DCIM/Camera/IMG_20201005_064250.jpg", bmOptions);
